        ...
        <div class="overflow-y-auto p-6 space-y-5">
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 hover:shadow-md transition">
                ...
                <div class="flex justify-between px-2">
                    ...
                    <button onclick="window.location.href='{{ route('reports.create') }}'" class="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 transition font-semibold">Post</button>
                </div>
            </div>
                ...
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <div class="flex gap-2 items-center">
                            <span class="font-semibold text-gray-800">Audrey Stark</span>
                            <span class="text-xs text-gray-500">2 jam • Jl. Melati</span>
                        </div>
                    </div>
                </div>
                <p class="text-gray-700 text-sm mb-3">Jalan berlubang besar dekat sekolah sangat berbahaya untuk dilewati</p>
                <img src="{{ asset('images/jalan_berlubang.jpg') }}" class="rounded-lg mb-3 object-cover max-h-[400px] w-full">
                <div class="flex gap-2 mb-3">
                    <span class="px-3 py-1 text-xs rounded-full bg-pink-100 text-pink-700">Baru</span>
                    <span class="px-3 py-1 text-xs rounded-full bg-indigo-100 text-indigo-700">Infrastruktur</span>
                </div>
                <div class="flex justify-between items-center text-sm text-gray-500 border-t border-gray-100 pt-3">
                    <div class="flex gap-4">
                        <button class="hover:text-blue-600 transition"><i class="fa-regular fa-comment"></i> 3</button>
                        <button class="hover:text-red-500 transition"><i class="fa-solid fa-heart"></i> 128</button>
                    </div>
            ...
            <article class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 hover:shadow-md transition-all duration-300">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <div class="flex gap-2 items-center">
                            <span class="font-semibold text-gray-800">David Blend</span>
                            <span class="text-xs text-gray-500">12 menit • Jl. Ahmad Yani</span>
                        </div>
                    </div>
                </div>
                <p class="text-gray-700 text-sm mb-3">Pohon besar tumbang menutupi jalan raya, menyebabkan kemacetan parah.</p>
                <img src="{{ asset('images/pohon-tumbang.jpg') }}" class="rounded-lg mb-3 object-cover max-h-[400px] w-full">
                <div class="flex gap-2 mb-3">
                    <span class="px-3 py-1 text-xs rounded-full bg-pink-100 text-pink-700">Baru</span>
                    <span class="px-3 py-1 text-xs rounded-full bg-indigo-100 text-indigo-700">Bencana Alam</span>
                </div>
                <div class="flex justify-between items-center text-sm text-gray-500 border-t border-gray-100 pt-3">
                    <div class="flex gap-4">
                        <button class="hover:text-blue-600 transition"><i class="fa-regular fa-comment"></i> 1</button>
                        <button class="hover:text-red-500 transition"><i class="fa-solid fa-heart"></i> 54</button>
                    </div>
                    <button class="text-xs text-blue-600 hover:underline">Lihat detail</button>
                </div>
            </article>
